    ...
    public class GameController : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            for (int i = 0; i < closestEnemies.Count; i++)
            {
                ...
                closestEnemies[i].soldierParticleSystem.Stop();
            }
            ...
            for (int i = 0; i < friendlySoldiers.Count; i++)
            {
                ...
                if (useSpatialPartition)
                {
                    ...
                    Buttontxt.text = "Partiton On";
                }
                else
                {
                    closestEnemy = FindClosestEnemySlow(friendlySoldiers[i]);
                    Buttontxt.text = "Partiton Off";
                }
                ...
                if (closestEnemy != null)
                {
                    ...
                    closestEnemy.soldierParticleSystem.Play();
            ...
            currentTime = (Time.realtimeSinceStartup - startTime) * 1000f;


            //TimerTxt.text = string.Format("{00:0}  "+ "ms", currentTime);
            TimerTxt.SetText(currentTime.ToString() + "ms");


            Debug.Log(currentTime.ToString() + "ms");
        }
